...
func (g *GamePostgres) GetGame(gameId int64) (model.GameUsers, error) {
...
func (g *GamePostgres) GetTime(gameId, userId int64) (model.Time, error) {
	var time model.Time
...
func (g *GamePostgres) AddGame(userIdFirst, userIdSecond int64) (int64, error) {
	var id int64
...
func (g *GamePostgres) AddTime(gameId, userId, time int64) error {
...
func (g *GamePostgres) UpdateTime(gameId, userId, time int64) error {
...
func (g *GamePostgres) GetRoomById(roomId int64) (model.Room, error) {
	var room model.Room
...
func (g *GamePostgres) AddCall(userIdFirst, userIdSecond, roomIdFirst int64) (model.Game, error) {
	var count int64
	tx, err := g.db.Begin()
	if err != nil {
...
func (g *GamePostgres) DeleteCall(userIdFirst, userIdSecond int64) error {
...
func (g *GamePostgres) GetListOfEdges(startRoomId int64) ([]model.Edge, error) {
...
func (g *GamePostgres) GetEdge(startRoomId, endRoomId int64) (model.Edge, error) {
	var edges []model.Edge
...
func (g *GamePostgres) GetRoomByCodePattern(code string, campusId int64) ([]model.Room, error) {

...
func (x *MessageRequest) GetUserTo() int64 {
	if x != nil {
		return x.UserTo
	}
	return 0
...
func (x *MessageResponse) GetUserFrom() int64 {
	if x != nil {
		return x.UserFrom
	}
	return 0
...
var file_chat_service_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0x43, 0x0a, 0x0e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75,
	...
	0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x74, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06,
	0x75, 0x73, 0x65, 0x72, 0x54, 0x6f, 0x22, 0x48, 0x0a, 0x0f, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	0x65, 0x6e, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x66, 0x72, 0x6f, 0x6d,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x46, 0x72, 0x6f, 0x6d,
	0x32, 0x5a, 0x0a, 0x0b, 0x43, 0x68, 0x61, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x4b, 0x0a, 0x0a, 0x44, 0x6f, 0x43, 0x68, 0x61, 0x74, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x1b, 0x2e,
	0x72, 0x75, 0x6e, 0x2e, 0x68, 0x73, 0x65, 0x2e, 0x72, 0x75, 0x6e, 0x2e, 0x4d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x72, 0x75, 0x6e,
	0x2e, 0x68, 0x73, 0x65, 0x2e, 0x72, 0x75, 0x6e, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
...
var file_chat_service_proto_goTypes = []interface{}{
	(*MessageRequest)(nil),  // 0: run.hse.run.MessageRequest
	(*MessageResponse)(nil), // 1: run.hse.run.MessageResponse
}
var file_chat_service_proto_depIdxs = []int32{
	0, // 0: run.hse.run.ChatService.DoChatting:input_type -> run.hse.run.MessageRequest
	1, // 1: run.hse.run.ChatService.DoChatting:output_type -> run.hse.run.MessageResponse
